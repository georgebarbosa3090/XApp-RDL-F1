...
A operação da camada RDL divide-se em quatro componentes especializados, cujo pipeline detalhado de decisão em lote e \textit{pass-through} contínuo é apresentado a seguir:
