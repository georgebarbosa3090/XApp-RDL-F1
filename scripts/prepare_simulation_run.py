#!/usr/bin/env python3
"""
Prepara, Executa e Autentica a Campanha de Simulacao do XApp-RDL-F1 (H-RDL)
Gera evidencias brutas, manifestos com hash SHA-256 e relatorio consolidado S0-S8.
"""
import os
import sys
import time
...
CLAIMS_FILE = os.path.join(BASE_DIR, "reproducibility", "claims.yaml")
...
def main():
    print("=" * 80)
    print(" PREPARADOR E AUTENTICADOR DE SIMULACAO — FASE 1 H-RDL")
    print("=" * 80)

    # 1. Executa suite de simulacao S0-S8
    sim_script = os.path.join(BASE_DIR, "scripts", "run_full_campaign_s0_s8.py")
    print(f"[1/4] Executando campanha S0-S8 via {sim_script}...")
