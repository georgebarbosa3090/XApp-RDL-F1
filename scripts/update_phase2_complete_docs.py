...
sudo apt-get update -y && sudo apt-get install -y \
  ...
  pkg-config wget curl ca-certificates libsctp-dev lksctp-tools \
  libzmq3-dev libboost-all-dev libsqlite3-dev libgsl-dev libxml2-dev \
  tcpdump wireshark gcc-11 g++-11
```
